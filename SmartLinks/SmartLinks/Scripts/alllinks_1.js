var lightBox = function () {
    var show = function () {
        ...
        default_imgs = ['./Content/images/peace.png', './Content/images/data.png', './Content/images/daisy.png'
            ...
            , './Content/images/CPK.png', './Content/images/JOBORDER.png', './Content/images/SUBASSEMBLY.png', './Content/images/WAFER.png', './Content/images/ShareFile.png', './Content/images/SNPROGRESS.png'];
        default_imgs_ie8 = ['./Content/images/ie8/peace.png', './Content/images/ie8/data.png', './Content/images/ie8/daisy.png'
            ...
            , './Content/images/ie8/CPK.png', './Content/images/ie8/JOBORDER.png', './Content/images/ie8/SUBASSEMBLY.png', './Content/images/ie8/WAFER.png', './Content/images/ie8/ShareFile.png', './Content/images/ie8/SNPROGRESS.png'];
        default_links_ie8 = ['AGILE', 'BR', 'DOMINO', 'ERP', 'FA', 'TRACEVIEW', 'DAISY', 'OA', 'CLOVER', 'SCRAP'
            , 'COMPONENT', 'VIDEO', 'LEGO', 'ASSETS', 'DISTRIBUTION', 'SCRAPRATE', 'HPUTREND', 'SNTESTSTATUS', 'VCSEL', 'CPK', 'JOBORDER', 'SUBASSEMBLY', 'WAFER', 'SHAREFILE', 'SNPROGRESS'];

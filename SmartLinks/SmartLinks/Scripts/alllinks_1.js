var lightBox = function () {
    var show = function () {
        ...
        default_links_ie8 = ['AGILE', 'BR', 'DOMINO', 'ERP', 'FA', 'TRACEVIEW', 'DAISY', 'OA', 'CLOVER', 'SCRAP', 'COMPONENT', 'VIDEO', 'LEGO', 'ASSETS', 'DISTRIBUTION', 'SCRAPRATE', 'HPUTREND', 'SNTESTSTATUS', 'VCSEL'];

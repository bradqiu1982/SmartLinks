var ModuleAssembly = function () {
    var show = function () {
        ...
        function RefreshWaferTable(warning) {
            ...
            $.post('/SmartLinks/ModuleSubAssemblyData',
           {
               ...
               $.each(output.assemblylist, function (i, val) {
                   var appendstr = '<tr>';
                   appendstr += '<td>' + val.SN + '</td>';
                   appendstr += '<td>' + val.PN + '</td>';
                   //appendstr += '<td>' + val.Desc + '</td>';
                   appendstr += '<td>' + val.AssemblySN + '</td>';
                   appendstr += '<td>' + val.AssemblyPN + '</td>';
                   appendstr += '<td>' + val.AssemblyDesc + '</td>';
                   appendstr += '<td>' + val.StepName + '</td>';
                   appendstr += '<td>' + val.IssueDate + '</td>';
                   appendstr += '</tr>';

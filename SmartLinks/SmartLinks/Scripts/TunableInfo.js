var TunableInfo = function () {
    var show = function () {
        ...
        function RefreshWaferTable(warning) {
            ...
            $.post('/SmartLinks/GetTunableInfoData',
           {
               ...
               $.each(output.tunablelist, function (i, val) {
                   var appendstr = '<tr>';
                   appendstr += '<td>' + val.SN + '</td>';
                   appendstr += '<td>' + val.PN + '</td>';
                   appendstr += '<td>' + val.CSN + '</td>';
                   appendstr += '<td>' + val.CName + '</td>';
                   appendstr += '<td>' + val.CPN + '</td>';
                   appendstr += '<td>' + val.MFRName + '</td>';
                   appendstr += '</tr>';
